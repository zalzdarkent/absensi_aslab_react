...
export default function AslabsCreate({ availablePermissions }: Props) {
  ...
  const { data, setData, post, processing, errors, reset } = useForm<FormData>({
    ...
    prodi: '',
    semester: '',
    permissions: Object.entries(availablePermissions)
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="border-b pb-4">
                    ...
                    <p className="text-sm text-muted-foreground">Tentukan hak akses spesifik untuk aslab ini. Secara default, hak akses di luar User dan Role Management sudah terpilih.</p>
                  </div>
