        ...
        <AppLayout>
            ...
            <div className="space-y-6 pt-4">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit {user.name}</h1>
                        <p className="text-muted-foreground mt-2">
                            Perbarui data user sistem
                        </p>
                    </div>
                </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    <div className="border-b pb-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">Perbarui data personal user</p>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <div className="border-b pb-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">Perbarui role dan data akademik user</p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            {user.rfid_code ? `RFID saat ini: ${user.rfid_code}. Masukkan kode baru untuk mengubah.` : 'Belum ada RFID terdaftar. Masukkan kode untuk mendaftarkan.'}
                                        </p>
                                ...
                                <div className="space-y-6">
                                    <div className="border-b pb-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">Sesuaikan hak akses spesifik untuk user ini.</p>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <div className="border-b pb-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">Kelola status aktivitas user</p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Hanya user aktif yang dapat menggunakan sistem
                                        </p>
                                    </div>
                                </div>
